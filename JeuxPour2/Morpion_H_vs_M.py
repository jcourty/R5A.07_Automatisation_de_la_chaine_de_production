...
def tour(tab : list[str], player : str, pl1 : str, bot : str):
...
def jeu_morpion_H_vs_M(joueur1 : str, score_j1 : int)-> int:
    ...
    while gagne == 0:
        time.sleep(1)
        tour(grille, joueur, joueur1, "bots" )        # permet au joueur de placer son caractère sur la grille 
